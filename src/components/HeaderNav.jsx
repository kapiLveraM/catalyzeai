...
import logo from "../assets/image/png/logoHeader.png";
  ...
  return (
    <div className=" mt-2">
      <nav className="header">
        <div className="container container_modified  py-3 d-lg-flex d-none justify-content-between align-items-center ">
